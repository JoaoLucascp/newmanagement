...
class FixedLine extends \CommonDBTM
{
    ...
    {
        // Usa a tabela de linhas do IPBX (não a legada fixedlines)
    ...
    public function displayTabContentForCompany(int $companies_id): void
    {
        ...
        $ipbx_id = 0;
        // Buscar o IPBX vinculado a esta empresa
        $ipbx_rows = $DB->request(['FROM' => 'glpi_plugin_newmanagement_ipbx', 'WHERE' => ['companies_id' => $companies_id, 'is_deleted' => 0], 'LIMIT' => 1]);

...
**Propósito:** Visão geral completa do plugin  
**Público:** Todos (produto, desenvolvimento, stakeholders)  
**Conteúdo:**
...
**Propósito:** Prompt especializado para debug e refatoração  
**Público:** Desenvolvedores, QA, Tech Lead  
**Conteúdo:**
...
### 3. 🏗️ **PADROES_GLPI.md**
**Propósito:** Referência de conformidade com GLPI 11  
...
**Propósito:** Roadmap de desenvolvimento até v2.0.0  
